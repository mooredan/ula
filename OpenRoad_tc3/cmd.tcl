...
set y 6.4
place_pin -pin_name {en}  -layer metal2 -location [list $x $y] -pin_size {2.4 0.9}
set x [expr ${die_urx} - 1.2]
set y 6.4
place_pin -pin_name {out} -layer metal2 -location [list $x $y] -pin_size {2.4 0.9}
